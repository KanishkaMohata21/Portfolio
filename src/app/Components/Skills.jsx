  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-0 mb-16 mt-10">
      ...
      <div className="relative flex items-center justify-center">
        {startIndex > 0 && (
          <button onClick={prevSkills} className="absolute left-0 p-2 bg-gray-800 text-white rounded-full mr-8">
            &#9664;
          </button>
        )}
        ...
        {(startIndex + skillsPerPage) < skills.length && (
          <button onClick={nextSkills} className="absolute right-0 p-2 bg-gray-800 text-white rounded-full ml-8">
            &#9654;
          </button>
        )}
      </div>
